...
#ifdef __co_NO_RUNTIME
  #undef __co_NO_RUNTIME
  #define __co_NO_RUNTIME 1
  inline static void __co_panic(const char* message) { __builtin_abort(); }
#else
  #define __co_NO_RUNTIME 0
